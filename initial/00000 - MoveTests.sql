...
begin
  ...
  GM_GenerateMoveTest(3,101,4,6);
  GM_GenerateMoveTest(3,102,4,6);
  GM_GenerateMoveTest(3,103,4,6);
  GM_GenerateMoveTest(3,104,4,6);
  GM_GenerateMoveTest(3,105,4,6);
  GM_GenerateMoveTest(3,109,4,6);
end;
exec  GM_GenerateMoveTest(3,101,4,6);
exec  GM_GenerateMoveTest(3,102,4,6);
exec  GM_GenerateMoveTest(3,103,4,6);
exec  GM_GenerateMoveTest(3,104,4,6);
exec  GM_GenerateMoveTest(3,105,3,7);
exec  GM_GenerateMoveTest(3,109,4,3);
