 ...
 */
-- white pieces
insert into gm_gamedef_css(gamedef_code, css_selector, css_definition, css_order) values('CHECKERS', '[player="1"][piece-name="man"]' ,'{height:70px;width:70px;background-size: 70px 70px; background-image: url("https://upload.wikimedia.org/wikipedia/commons/9/90/Draughts_mlt45.svg");}',100);
insert into gm_gamedef_css(gamedef_code, css_selector, css_definition, css_order) values('CHECKERS', '[player="1"][piece-name="king"]' ,'{height:70px;width:70px;background-size: 70px 70px; background-image: url("https://upload.wikimedia.org/wikipedia/commons/a/a6/Draughts_klt45.svg");}',100);

-- black pieces
insert into gm_gamedef_css(gamedef_code, css_selector, css_definition, css_order) values('CHECKERS', '[player="2"][piece-name="man"]' ,'{height:70px;width:70px;background-size: 70px 70px; background-image: url("https://upload.wikimedia.org/wikipedia/commons/0/0c/Draughts_mdt45.svg");}',100);
insert into gm_gamedef_css(gamedef_code, css_selector, css_definition, css_order) values('CHECKERS', '[player="2"][piece-name="king"]' ,'{height:70px;width:70px;background-size: 70px 70px; background-image: url("https://upload.wikimedia.org/wikipedia/commons/9/9a/Draughts_kdt45.svg");}',100);
